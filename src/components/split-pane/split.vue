...
export default {
   ...
   * Events
   * @on-move-start
   * @on-moving Return value: Event object, but two parameters are added to the event object: atMin (currently at the minimum value), atMax (currently at the maximum value)
   * @on-move-end
   */
  data () {
    return {
